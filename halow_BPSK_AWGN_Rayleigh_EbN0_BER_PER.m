...
number_symbol_per_packet = 2000; % number of symbol per packet
SER_SNR_threshold = 1 - 10^(-0.3/number_symbol_per_packet); % -0.3 berasal dari log10(1/2)
...
N = 6; % bytes. usahakan kelipatan 6
